...
We could do something like the following to create templates for those URLs 
which are about individual items: 
...
```html
<head>
  <meta name="DC.title" content="Title of Digital Object" />
</head>
```
