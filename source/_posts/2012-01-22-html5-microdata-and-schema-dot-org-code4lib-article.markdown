---
layout: post
title: "HTML5 Microdata and Schema.org (Code4Lib Article)"
date: 2012-01-22 13:53
updated: 2012-01-22
comments: true
...
This article was first published in the [Code4Lib Journal](YKK). This page
may be updated to include any fixes from that version.
...
{% img /images/vegan_cupcakes.png [Rich Snippet for Vegan Cupcakes search [Rich Snippet for Vegan Cupcakes search]] %}
...
{% img /images/bell_tower_screenshot.png [Screenshot of page for digital photograph [Screenshot of page for digital photograph]] %}
...
{% img /images/nested_itemtypes.png [Nested types for photograph example [Nested types for photograph example]] %}
...
{% img /images/memorial_tower_snippet.png [Possible Rich Snippet for Example Microdata Markup [Possible Rich Snippet for Example Microdata Markup]] %}
